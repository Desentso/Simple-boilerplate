...
const FOOTER_NAVIGATION = {
  ...
  support: [
    ...
    { name: 'Documentation', href: '/docs', isActualLink: true },
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            <p className='text-4xl font-semibold text-white example-logo-font'>Example</p>
        ...
        <div className="mt-12 border-t border-gray-400 pt-8">
          <p className="text-base text-gray-300 xl:text-center">&copy; 2023 Example.com - All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
